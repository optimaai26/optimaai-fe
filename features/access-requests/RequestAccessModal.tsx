        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-md animate-fade-in">
            <div className="bg-background/95 backdrop-blur-xl border border-border/50 rounded-2xl shadow-2xl ring-1 ring-white/10 w-full max-w-md overflow-hidden animate-slide-up">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    <div>
                        <label className="block text-sm font-medium text-foreground mb-1">Requested Role</label>
                        <Select 
                            value={role} 
                    ...
                    <div>
                        <label className="block text-sm font-medium text-foreground mb-1">Business Justification</label>
                        <textarea 
                            value={justification}
