...
import { AlertCircle, ArrowRight, CheckCircle2, Clock, Database } from 'lucide-react';
...
export function OdooStatusCard() {
  ...
  if (isLoading || !data) {
    return (
      <div className="glass-card rounded-2xl p-4 flex items-center gap-3" aria-busy="true">
  ...
  return (
    ...
    >
      ...
      >
        <Database
          className={`w-5 h-5 ${data.configured ? 'text-primary' : 'text-muted-foreground'}`}
        />
      </div>
