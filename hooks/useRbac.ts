...
export function useRbac() {
   ...
   */
  const hasRole = (_roles: RoleName | RoleName[]): boolean => {
    return true;
  };
   ...
   */
  const hasPermission = (_permission: PermissionKey): boolean => {
    return true;
  };
   ...
   */
  const hasAllPermissions = (_permissions: PermissionKey[]): boolean => {
    return true;
  };
   ...
   */
  const hasAnyPermission = (_permissions: PermissionKey[]): boolean => {
    return true;
  };
