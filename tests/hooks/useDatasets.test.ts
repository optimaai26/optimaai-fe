...
import { useDatasets, useCreateDataset } from '@/features/datasets/useDatasets';
...
describe('useDatasets integration', () => {
    ...
    it('allows triggering standard dataset creation', async () => {
        const { result } = renderHook(() => useCreateDataset(), { wrapper: Providers });
        
        const testPayload = { name: 'Test DB', source: 'CSV', rowCount: 100, storageSize: '1MB' };
