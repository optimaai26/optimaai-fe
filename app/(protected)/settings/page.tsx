...
import { Bell, Database, Globe, Paintbrush, Settings2, Shield } from 'lucide-react';
          ...
          {activeTab === 'appearance' && (
            <div className="glass-card rounded-xl p-6 animate-fade-in">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                Customize how OptimaAI looks on your device. Alternatively, use the quick-toggle in
          ...
          {activeTab !== 'appearance' && (
            <div className="glass-card rounded-xl p-10 flex flex-col items-center justify-center text-center animate-fade-in border-dashed min-h-[300px]">
              ...
              <p className="text-sm text-muted-foreground max-w-sm mx-auto">
                The {tabs.find((t) => t.id === activeTab)?.label} settings module is currently under
                active development.
              </p>
            </div>
          )}
