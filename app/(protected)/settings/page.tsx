...
import { Bell, Shield, Paintbrush, Globe, Database, Settings2 } from 'lucide-react';
                ...
                <div className="md:col-span-3 space-y-6">
                    {activeTab === 'appearance' && (
                        <div className="glass-card rounded-xl p-6 animate-fade-in">
                            ...
                            <p className="text-sm text-muted-foreground mb-6">Customize how OptimaAI looks on your device. Alternatively, use the quick-toggle in the top right header.</p>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between py-3 border-b border-border">
                                    <div>
                                        ...
                                        <p className="text-xs text-muted-foreground mt-0.5">Reduce padding slightly to fit more data on screen.</p>
                                    </div>
                    ...
                    {activeTab !== 'appearance' && (
                        <div className="glass-card rounded-xl p-10 flex flex-col items-center justify-center text-center animate-fade-in border-dashed min-h-[300px]">
                            ...
                            <p className="text-sm text-muted-foreground max-w-sm mx-auto">
                                The {tabs.find(t => t.id === activeTab)?.label} settings module is currently under active development.
                            </p>
                        </div>
                    )}
                </div>
