            ...
            <div className="grid gap-6">
                ...
                <div className="glass-card rounded-xl p-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="text-sm font-medium text-muted-foreground block mb-1.5">Bio</label>
                            <textarea 
                    ...
                    <div className="flex items-center justify-between p-4 border border-border rounded-lg bg-background/50">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground mt-0.5">It's a good idea to use a strong password that you're not using elsewhere.</p>
                            </div>
                        </div>
