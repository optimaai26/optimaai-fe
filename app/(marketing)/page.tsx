import { ArrowRight, BarChart3, BrainCircuit, Database, Shield, Sparkles } from 'lucide-react';
...
const features = [
    {
        ...
        description: 'Upload CSV files and let our AI clean, transform, and prepare your data automatically.',
    },
    {
        icon: BrainCircuit,
        title: 'ML Predictions',
        description: 'Churn prediction, revenue forecasting, and growth scoring powered by cutting-edge models.',
    },
    {
        icon: Sparkles,
        title: 'AI Insights',
        description: 'LLM-generated strategic recommendations tailored to your business data.',
    },
    {
        icon: BarChart3,
        title: 'Smart Charts',
        description: 'AI suggests the best chart type for your data. Explore alternatives with one click.',
    },
    {
        icon: Shield,
        title: 'Role-Based Access',
        description: 'Fine-grained RBAC with department scoping and access request workflows.',
    },
];
            ...
            <section className="relative pt-32 pb-20 px-6 overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
                        Upload your data, get ML predictions, receive AI-generated insights, and build your Business Model Canvas — all in one platform.
                    </p>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                            From raw CSV to actionable strategy — OptimaAI handles the entire analytics pipeline.
                        </p>
                    </div>
